...
builder.Services.AddRateLimiter(options =>
{
    ...
    options.AddPolicy("auth", context => FixedWindow(context, 30, TimeSpan.FromMinutes(5)));
    options.AddPolicy("signup", context => FixedWindow(context, 200, TimeSpan.FromMinutes(5)));
