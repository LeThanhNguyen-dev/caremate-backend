...
namespace MomCare.Infrastructure.PostgreSqlMigrations
{
    ...
    [Migration("20260615035719_AddAiChatAndCarePlanTelemetry")]
    partial class AddAiChatAndCarePlanTelemetry
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MomCare.Models.AiCarePlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<bool>("FallbackMode")
                        .HasColumnType("boolean")
                        .HasColumnName("fallback_mode");

                    b.Property<string>("GeminiPromptVersion")
                        .HasMaxLength(80)
                        .HasColumnType("character varying(80)")
                        .HasColumnName("gemini_prompt_version");

                    b.Property<Guid?>("HealthCheckInId")
                        .HasColumnType("uuid")
                        .HasColumnName("health_checkin_id");

                    b.Property<bool>("IsAiReasoned")
                        .HasColumnType("boolean")
                        .HasColumnName("is_ai_reasoned");

                    b.Property<string>("PlanItemsJson")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("plan_items_json");
                    ...
                    b.Property<string>("RecommendedNursesJson")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("recommended_nurses_json");

                    b.Property<string>("RecommendedServicesJson")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("recommended_services_json");
                    ...
                    b.Property<string>("SafetyNotice")
                        .HasColumnType("text")
                        .HasColumnName("safety_notice");
                    ...
                    b.Property<string>("SymptomTagsJson")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("symptom_tags_json");
                    ...
                    b.ToTable("ai_care_plans");
                });

            modelBuilder.Entity("MomCare.Models.AiChatConversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("UserId", "Status", "LastMessageAt");

                    b.ToTable("ai_chat_conversations");
                });

            modelBuilder.Entity("MomCare.Models.AiChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<bool>("SafetyFlag")
                        .HasColumnType("boolean")
                        .HasColumnName("safety_flag");

                    b.Property<string>("SafetyTriggeredBy")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("safety_triggered_by");
            ...
            modelBuilder.Entity("MomCare.Models.AiHealthAnalysis", b =>
                {
                    ...
                    b.Property<string>("AiFallbackMode")
                        .HasMaxLength(80)
                        .HasColumnType("character varying(80)")
                        .HasColumnName("ai_fallback_mode");

                    b.Property<long?>("AiLatencyMs")
            ...
            modelBuilder.Entity("MomCare.Models.GeminiCallLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("MomCare.Models.AiChatMessage", b =>
                {
                    b.HasOne("MomCare.Models.AiChatConversation", "Conversation")
                        .WithMany("Messages")
