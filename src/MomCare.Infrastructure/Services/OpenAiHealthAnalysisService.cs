        ...
        IReadOnlyList<SuggestedServiceDto> availableServices)
    {
        var promptObject = new
        {
            ...
            currentCheckIn = new
            {
                ...
                contextData = JsonSerializer.Deserialize<Dictionary<string, string>>(currentCheckIn.ContextDataJson, JsonOptions) ?? [],
            ...
            recentHistory = recentHistory
                ...
                .Select(x => new
                {
                    ...
                    contextData = JsonSerializer.Deserialize<Dictionary<string, string>>(x.ContextDataJson, JsonOptions) ?? [],
                    x.MotherAge,
            ...
            rules = new[]
            {
                ...
                "Use contextData as extra structured postpartum and newborn data. Pay special attention to heavy bleeding, wound concerns, severe swelling, urination difficulty, very few wet diapers, and unusually sleepy or weak baby activity.",
